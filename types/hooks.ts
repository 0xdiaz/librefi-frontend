...
// GraphQL hooks
export interface UseGraphQLQueryParams<T = unknown> {
  query: string;
...
export interface UseGraphQLMutationParams<T = unknown> {
  mutation: string;
  options?: {
...
// Form hooks
export interface UseFormParams<T = unknown> {
...
// Filtering hooks
export interface UseFilteringParams<T = unknown> {
  defaultFilters?: T;
  onChange?: (filters: T) => void;
}

export interface UseFilteringReturn<T = unknown> {
  filters: T;
