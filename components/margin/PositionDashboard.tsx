...
export function PositionDashboard({ poolAddress, onCreatePosition }: PositionDashboardProps) {
  ...
  const getPoolDetails = (lendingPoolAddress: Address) => {
    ...
    const poolIndex = poolAddresses.findIndex(addr => addr.toLowerCase() === lendingPoolAddress.toLowerCase());
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex justify-between items-center'>
        <h2 className='text-xl font-semibold'>{poolAddress ? 'Pool Positions' : 'My Positions'}</h2>
