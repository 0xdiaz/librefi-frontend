    ...
    <div className='bg-card rounded-lg border p-6 shadow-sm'>
      ...
      <div className='mt-6 p-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg'>
        <p className='text-sm text-blue-700 dark:text-blue-300'>
          Note: These tokens are for testing purposes only on the Base Sepolia testnet. To add a token to your wallet,
          copy the token address and import it as a custom token.
        </p>
      </div>
    </div>
  );
