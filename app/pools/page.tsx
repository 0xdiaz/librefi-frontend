        ...
        <div className='container mx-auto px-4 lg:px-8 py-8'>
          <div className='flex flex-col gap-6'>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
              ...
              {isClient ? (
                <Button onClick={handleCreatePool} className='gap-2' disabled={!isConnected}>
            ...
            {isLoading ? (
              <>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  {[...Array(6)].map((_, i) => (
                    <div key={`pool-skeleton-${i}`} className='bg-card animate-pulse rounded-lg h-64 border'>
              ...
              <div className='text-center py-12 border rounded-lg bg-card'>
                <div className='max-w-md mx-auto space-y-4'>
                  ...
                  {isClient && isConnected && (
                    <Button onClick={() => router.push('/pools/create')} className='gap-2'>
                      <Plus className='size-4' />
                      Create First Pool
                    </Button>
                  )}
              ...
              <div>
                ...
                {searchTerm && filteredPools.length === 0 ? (
                  <div className='text-center py-12 border rounded-lg bg-card'>
                    <p className='text-muted-foreground'>No pools match your search for &quot;{searchTerm}&quot;</p>
